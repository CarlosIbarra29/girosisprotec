        ...
        <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row bg-white"
            ...
            <div class="d-flex block-mobile">
                <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-6 py-lg-13 px-lg-12">
                    ...
                    <!-- Logo -->
                    <a href="javascript:;" class="text-center pt-4 pb-4 login-logo">
                    ...
                    <div class="d-flex flex-column-fluid flex-column flex-center">
                        <!-- Signin -->
                        <div class="login-form login-signin py-3">
                            <div class="login-panel">
                                ...
                                <form class="form" action="{{ route('login') }}" method="post" autocomplete="off"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control h-auto rounded-lg" type="password"
            ...
            <!-- Lado derecho (imagen) -->
            <div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center bgi-no-repeat p-8 p-sm-30 hidden-mobile login-illustration">
            </div>
        </div>
        <!--end::Login-->
    </div>
